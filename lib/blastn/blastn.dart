...
//   }
// }
// display(List seque1,List seque2){
//   int le=60;
//   while(seque1.length>=0){
//      Text('sequence1: ');
//      for(int a=seque1[le-40];a<le;a++){
//        Text('$a');
//      }
//      Text("\n");
//         Text('           ');
//     for(int k=le-40;k<le;k++){
//        if (seque1[k] == seque2[k])  print('|');
//             else Text(' ');
//     }
//     Text("\n");
//     Text('sequence2: ');
//     for(int b=seque2[le-40];b<le;b++){
//        Text('$b');
//     }
//     Text("\n");
//      le += 40;
...
//        Text('sequence1: ');
//        for(int a=seque2[le-40];a<seque2.length;a++){
//           Text('$a');
//        }
//        Text("\n");
//         Text('           ');
//         for(int k=seque1[le-40];k<seque1.length;k++){
...
//           Text("\n");
//         Text('sequence2: ');
//         for(int b=seque2[le-40];b<seque2.length;b++){
//           Text('$b');
//         }
//          Text("\n");
//         }
...
//    for(int chrNames=0;chrNames<retrevedData.toString().length;chrNames++){

//      String chrSeq=retrevedData.toString();
...
//  }
//  int length=retrevedData.toString().length;
//  String extractSeq(int chrIndex,int pos,int lenght)
//  {
//     pos=pos+(pos/60).floor();
//      String chr=retrevedData.toString();
